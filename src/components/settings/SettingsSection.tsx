          ...
          {activeRankPoints.map((value, idx) => (
            <div key={idx} className="bg-abyss p-4 rounded-2xl border border-slate-700/80 shadow-inner">
              ...
              <input
                ...
                className="w-full bg-panel-3 border border-slate-700 rounded-xl px-3 py-3 text-slate-100 focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400/50 font-mono text-lg text-center transition-all"
              />
            </div>
          ))}
        </div>
