...
export function DayDetailModal({
  ...
  return createPortal(
    ...
    >
      ...
      <div className="relative w-full max-w-2xl bg-panel border border-emerald-500/40 rounded-3xl p-6 md:p-8 shadow-[0_0_50px_rgba(16,185,129,0.2)] overflow-hidden max-h-[85vh] overflow-y-auto">
