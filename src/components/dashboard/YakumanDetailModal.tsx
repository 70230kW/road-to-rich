...
export function YakumanDetailModal({
  ...
  return (
    ...
    >
      ...
      <div className="mobile-sheet relative w-full max-w-md bg-panel border border-purple-500/40 rounded-3xl p-6 md:p-8 shadow-[0_0_50px_rgba(168,85,247,0.2)] overflow-hidden max-h-[85vh] overflow-y-auto">
