...
export function CurrentProfitsBar({ games, players }: { games: Game[]; players: Player[] }) {
  ...
  return (
    <div className="bg-panel-2/60 p-5 md:p-6 rounded-3xl border border-cyan-900/40 shadow-[0_0_20px_rgb(var(--accent-rgb-500)/0.1)] backdrop-blur-sm animate-fade-in">
