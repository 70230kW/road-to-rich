  ...
  return (
    <fieldset disabled={saving} className="space-y-8 animate-fade-in border-0 p-0 min-w-0">
      ...
      <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="flex items-center justify-between gap-3 mb-4 bg-abyss/80 p-3.5 rounded-2xl border border-slate-800/80">
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-28 bg-panel-3 border rounded-xl px-4 py-2.5 text-slate-100 focus:outline-none focus:ring-1 font-mono text-right text-lg transition-all ${
        ...
        <div className="bg-gradient-to-br from-panel-2 to-abyss p-6 md:p-8 rounded-3xl border border-slate-700/50 shadow-[0_0_30px_rgba(0,0,0,0.5)] relative">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="flex items-center justify-between gap-3 bg-panel-3 px-4 py-2.5 rounded-xl border border-slate-800">
                    ...
                    <div className="flex items-center justify-between gap-3 bg-panel-3 px-4 py-2.5 rounded-xl border border-cyan-900/50">
