export function Header() {
  return (
    <header className="mb-8 md:mb-10 text-center pt-6 md:pt-8 pb-4 relative">
      ...
      <h1 className="text-3xl sm:text-4xl md:text-6xl font-black font-brand tracking-[0.1em] md:tracking-[0.15em] text-transparent bg-clip-text bg-gradient-to-b from-white via-cyan-100 to-cyan-500 drop-shadow-[0_0_20px_rgba(6,182,212,0.8)] mb-3 relative z-10">
        じゃんかね
      </h1>
