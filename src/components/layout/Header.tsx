export function Header() {
  return (
    <header className="mb-8 md:mb-10 text-center pt-6 md:pt-8 pb-4 relative">
      ...
      <h1 className="text-3xl sm:text-4xl md:text-6xl font-black font-brand tracking-[0.1em] md:tracking-[0.15em] text-transparent bg-clip-text bg-gradient-to-b from-white via-cyan-100 to-cyan-500 drop-shadow-[0_0_20px_rgb(var(--accent-rgb-500)/0.8)] mb-3 relative z-10">
        じゃんかね
      </h1>
      <div className="flex items-center justify-center gap-3 relative z-10">
        <span className="w-8 md:w-12 h-[2px] bg-gradient-to-r from-transparent via-cyan-400 to-cyan-500" />
        <p className="text-cyan-300 text-[9px] sm:text-[10px] md:text-xs tracking-[0.1em] md:tracking-[0.2em] font-mono font-bold drop-shadow-[0_0_5px_rgb(var(--accent-rgb-500)/0.8)] uppercase">
          Road to Rich
        </p>
